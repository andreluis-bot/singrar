...
export function AchievementsView() {
  const { achievements, tracks, waypoints, logEntries, events, user } = useStore();
            ...
            return (
              <div 
                ...
                className={`p-5 rounded-3xl border transition-all duration-300 group ${
                  isUnlocked 
                    ? "bg-gradient-to-br from-[#112240] to-[#0a192f] border-[#64ffda]/30 shadow-[0_0_30px_rgba(100,255,218,0.05)] hover:border-[#64ffda]/50" 
                    : "bg-white/5 border-white/5 opacity-80 hover:opacity-100"
                }`}
              >
                <div className="flex gap-5">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-4xl shadow-inner shrink-0 transition-transform group-hover:scale-110 ${
                    isUnlocked ? "bg-[#64ffda]/10 border border-[#64ffda]/20" : "bg-[#0a192f] border border-white/5"
                  }`}>
